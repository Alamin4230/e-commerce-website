...
<head>
     <meta name="viewport" content="width=device-width, initial-scale=1">
        ...
        <title>Contact | Life Style BD</title>
        <style type="text/css">
            .p1{
                text-align: justify;
            }
...
?>
<div class="container" id="content" style="background-image: linear-gradient(#fbfcfb 0%, #7cccf7 100%);>
    <div class="row">
    <div class="col-lg">
    ...
    <div class="col-lg">
        <div style="float: right;">
            ...
            <p id="p1">Dhaka, Bangladesh - 1230</p><br>
            <p id="p1">Phone : +880 1601558881</p><br>
            <p id="p1">Email : alamin@gmail.com</p>
        </div>
        <h1>CONTACT US</h1>
