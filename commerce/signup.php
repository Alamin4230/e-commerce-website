...
<html lang="en">
    <head>
        ...
        <title>Signup | Life Style BD</title>
                    ...
                    <div class="container">
                        <div class="col-lg-4 col-lg-offset-3 col-md-6">
                            ...
                            <form  action="signup_script.php" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control"  placeholder="Contact (ex. 01601884441)" maxlength="11" size="11" name="contact" required = "true" pattern="^01[0-9]{9}$"> <?php if(isset($_GET['m2'])) echo $_GET['m2']; ?>
                                </div>
                                <div class="form-group">
