...
<head>
        ...
        <title>About us | Life Style BD</title>
...
<div style="background-image: linear-gradient(#fbfcfb 0%, #7cccf7 100%);>
    <div class="container" id="content">
        <img src="img\Untitled design.jpg" style="float: left;">
        <div class="row">
            <div class="col-lg-4" align="justify">
                <h3><mark>About this Project</mark></h3><br>
                <p id="p1">This is my web Developement project. Currently I am stduying at Daffodil Inter national university.<br><br>now in this web application is a basic project that represent a E-commerce site.
            </div>
            <div class="col-lg-4" align="justify">
